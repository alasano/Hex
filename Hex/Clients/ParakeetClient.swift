...
actor ParakeetClient {
  ...
  private let vendorDirs = [
    // Our app-specific cache path convention (under XDG or com.alasano.Hex/cache)
    "fluidaudio/Models",
    "FluidAudio/Models",
  ...
  private func candidateRoots() -> [URL] {
    ...
    let appCache = appSupport?.appendingPathComponent("com.alasano.Hex/cache", isDirectory: true)
